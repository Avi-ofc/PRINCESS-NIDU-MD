...
const xsteek = fs.readFileSync(`./attac/Avix.webp`)
const o = fs.readFileSync(`./attac/AAA.jpg`)

/*|⬡════════════════════════════════════════════|❝   𝙰vi -  database ™ ❞|═══════════════════════════════════════════⬡|*/ 

let premium = JSON.parse(fs.readFileSync('./attac/database/premium.json'))
let _owner = JSON.parse(fs.readFileSync('./attac/database/owner.json'))
let owner = JSON.parse(fs.readFileSync('./attac/database/owner.json'))
let _afk = JSON.parse(fs.readFileSync('./attac/database/afk-user.json'))
let hit = JSON.parse(fs.readFileSync('./attac/database/total-hit-user.json'))

/*|⬡════════════════════════════════════════════|❝   𝙰vi - autorep ™ ❞|═══════════════════════════════════════════⬡|*/ 

const VoiceNoteAvi = JSON.parse(fs.readFileSync('./attac/database/autoreply/vn.json'))
const StickerAvi = JSON.parse(fs.readFileSync('./attac/database/autoreply/sticker.json'))
const ImageAvi = JSON.parse(fs.readFileSync('./attac/database/autoreply/image.json'))
const VideoAvi = JSON.parse(fs.readFileSync('./attac/database/autoreply/video.json'))
const DocAvi = JSON.parse(fs.readFileSync('./attac/database/autoreply/doc.json'))
const ZipAvi = JSON.parse(fs.readFileSync('./attac/database/autoreply/zip.json'))
const ApkAvi = JSON.parse(fs.readFileSync('./attac/database/autoreply/apk.json'))
...
/*|⬡════════════════════════════════════════════|❝   𝙰vi - bot number online status, available=online, unavailable=offline  ™ ❞|═══════════════════════════════════════════⬡|*/ 

Avishka.sendPresenceUpdate('uavailable', from)
        
if (global.autorecordtype) {
let Avirecordin = ['recording','composing']
let Avirecordinfinal = Avirecordin[Math.floor(Math.random() * Avirecordin.length)]
Avishka.sendPresenceUpdate(Avirecordinfinal, from)
...
if (command) {
  const cmdadd = () => {
      hit[0].hit_cmd += 1
      fs.writeFileSync('./attac/database/total-hit-user.json', JSON.stringify(hit))
  }
  cmdadd()
  const totalhit = JSON.parse(fs.readFileSync('./attac/database/total-hit-user.json'))[0].hit_cmd
}

for (let BhosdikaAvi of VoiceNoteAvi) {
if (budy === BhosdikaAvi) {
let audiobuffy = fs.readFileSync(`./AMedia/audio/${BhosdikaAvi}.mp3`)
Avishka.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaAvi of StickerAvi){
if (budy === BhosdikaAvi){
let stickerbuffy = fs.readFileSync(`./AMedia/sticker/${BhosdikaAvi}.webp`)
Avishka.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaAvi of ImageAvi){
if (budy === BhosdikaAvi){
let imagebuffy = fs.readFileSync(`./AMedia/image/${BhosdikaAvi}.jpg`)
Avishka.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaAvi of VideoAvi){
if (budy === BhosdikaAvi){
let videobuffy = fs.readFileSync(`./AMedia/video/${BhosdikaAvi}.mp4`)
...
for (let BhosdikaAvi of ApkAvi) {
if (budy === BhosdikaAvi) {
let buffer = fs.readFileSync(`./AMedia/apk/${BhosdikaAvi}.apk`)
sendapk(buffer)
}
}
...
for (let BhosdikaAvi of ZipAvi) {
if (budy === BhosdikaAvi) {
let buffer = fs.readFileSync(`./AMedia/zip/${BhosdikaAvi}.zip`)
sendzip(buffer)
}
}
...
for (let BhosdikaAvi of DocAvi) {
if (budy === BhosdikaAvi) {
let buffer = fs.readFileSync(`./AMedia/doc/${BhosdikaAvi}.pdf`)
senddocu(buffer)
}
}
...
if (m.isGroup && !m.key.fromMe) {
  ...
  if (afk.checkAfkUser(m.sender, _afk)) {
      ...
      fs.writeFileSync('./attac/database/afk-user.json', JSON.stringify(_afk))
      Avishka.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} have returned from afk`, m)
  }
}

/*|⬡════════════════════════════════════════════|❝   𝙰vi - swith statemante  ™ ❞|═══════════════════════════════════════════⬡|*/ 
...
switch (command) {
  ...
  case 'delprem':
      ...
      if (m.mentionedJid.length !== 0) {
          for (let i = 0; i < m.mentionedJid.length; i++) {
              ...
              fs.writeFileSync("./attac/database/premium.json", JSON.stringify(premium));
          }
  ...
  case 'listprem':
      await sendReaction('⏳');
       {
      if (!isCreator) return replygcAvi(mess.owner)
      let data = require("./attac/database/premium.json")
  ...
  case 'getsession':
      ...
      let sesi = await fs.readFileSync('./session/Avi.json')
      Avishka.sendMessage(m.chat, {
          document: sesi,
...
await sendReaction('⏳');
{
  ...
  case 'getcase':
      ...
      if (!isCreator) return replygcAvi(mess.owner)
      const getCase = (cases) => {
          return "case" + `'${cases}'` + fs.readFileSync("AviBug3.js").toString().split('case \'' + cases + '\'')[1].split("break")[0] + "break"
      }
...
owner.push(bnnd)
fs.writeFileSync('./attac/database/owner.json', JSON.stringify(owner))
...
break
      ...
      await sendReaction('⏳');
  {
      ...
      fs.writeFileSync('./attac/database/autoreply/video.json', JSON.stringify(VideoAvi))
      fs.unlinkSync(delb)
      ...
      await sendReaction('⏳');
  {
      ...
      fs.writeFileSync('./attac/database/autoreply/image.json', JSON.stringify(ImageAvi))
      fs.unlinkSync(delb)
  ...
  await sendReaction('⏳');
  {
      ...
      fs.writeFileSync('./attac/database/autoreply/sticker.json', JSON.stringify(StickerAvi))
      fs.unlinkSync(delb)
      ...
      await sendReaction('⏳');
  {
      ...
      fs.writeFileSync('./attac/database/autoreply/vn.json', JSON.stringify(VoiceNoteAvi))
      fs.unlinkSync(delb)
...
fs.writeFileSync('./attac/database/autoreply/zip.json', JSON.stringify(ZipAvi))
fs.unlinkSync(delb)
...
//if (!m.isGroup) return XeonStickGroup()
	//if (!AntiNsfw) return replygcAvi(mess.nsfw)
//await XeonStickWait()
var ahegaonsfw = JSON.parse(fs.readFileSync('./src/media/anime/neko.json'))
var Aviresult = pickRandom(ahegaonsfw)
Avishka.sendMessage(m.chat, { caption: mess.success, image: { url: Aviresult.url } }, { quoted: m })
break
//---------------------------
...
fs.writeFileSync('./attac/database/autoreply/apk.json', JSON.stringify(ApkAvi))
fs.unlinkSync(delb)
...
fs.writeFileSync('./attac/database/autoreply/doc.json', JSON.stringify(DocAvi))
fs.unlinkSync(delb)
...
try {
  const Aviplaymp3 = require('./lib/ytdl')
let yts = require("youtube-yts")
let search = await yts(text)
let anup3k = search.videos[0]
const pl= await Aviplaymp3.mp3(anup3k.url)
await Avishka.sendMessage(m.chat,{
...
await sendReaction('⏳');
const Aviaudp3 = require('./lib/ytdl2')
if (args.length < 1 || !isUrl(text) || !Aviaudp3.isYTUrl(text)) return replygcAvi(`Where's the yt link?\nExample: ${prefix + command} https://youtube.com/shorts/YQf-vMjDuKY?feature=share`)
const audio=await Aviaudp3.mp3(text)
await Avishka.sendMessage(m.chat,{
...
await sendReaction('⏳');
{
const Avividoh = require('./lib/ytdl2')
if (args.length < 1 || !isUrl(text) || !Avividoh.isYTUrl(text)) replygcAvi(`Where is the link??\n\nExample : ${prefix + command} https://youtube.com/watch?v=PtFMh6Tccag%27 128kbps`)
const vid=await Avividoh.mp4(text)
const ytc=`
...
case "android": {
  ...
  if (!number || !amount) {
    return replygcAvi(`Real king Avi \n  ${prefix+command} \n \n හුත්තො නම්බරෙ ගහපන් බග් එක වදින්න ඔන එකාගෙ 🤬\n \n victim number|amount\nExample ${prefix+command} 94xxxxxxxxxx/ 3`) 
  }
...
break;
case 'ioskill22': case 'iosx22': {
            	if (!isPremium) return replygcAvi(mess.prem)
let Aviyvictim = q.replace(/[^0-9]/g, "")
if (Aviyvictim.startsWith('0')) return replygcAvi(`Example : .${command} 94xxxxxxxxxx`)
await replygcAvi(`In process....`)
...
case 'onekill22': {
  if (!isPremium) return replygcAvi(mess.prem)
if (!q) return replygcAvi(`Usage .${command} 94xxxxxxxxxx`)
let Aviyvictim = q.replace(/[^0-9]/g, "")
if (Aviyvictim.startsWith('0')) return replygcAvi(`Example : .${command} 94xxxxxxxxxx`)
let target = Aviyvictim + '@s.whatsapp.net'
await replygcAvi(`In process....`)
...
await replygcAvi(`Successfully Send Bug to ${Aviyvictim} Using ${command}. ✅`)
}
break
...
/*|⬡════════════════════════════════════════════|❝   𝙰vi - Menu  ™ ❞|═══════════════════════════════════════════⬡|*/             
    ...
    ┆ Bot Info  
    ▢─────┈ ⳹ 
    𝗕𝗼𝘁 𝗡𝗮𝗺𝗲 : AVI-CRASH 1.3V

    𝗢𝘄𝗻𝗲𝗿 𝗡𝗮𝗺𝗲 :  *AVISHKA SHAVINDA*

    𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 𝗡𝗮𝗺𝗲 : *AVISHKA SHAVINDA*
